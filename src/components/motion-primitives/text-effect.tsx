...
import { AnimatePresence, framer-motion, type TargetAndTransition, type Transition, type Variant, type Variants } from 'framer-motion/react'
...
const AnimationComponent: React.FC<{
    ...
    const content =
        per === 'line' ? (
            ...
            <framer-motion.span className="inline-block whitespace-pre">
...
export function TextEffect({ children, per = 'word', as = 'p', variants, className, preset = 'fade', delay = 0, speedReveal = 1, speedSegment = 1, trigger = true, onAnimationComplete, onAnimationStart, segmentWrapperClassName, containerTransition, segmentTransition, style }: TextEffectProps) {
    ...
    const MotionTag = framer-motion[as as keyof typeof framer-motion] as typeof framer-motion.div
